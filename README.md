...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/crimson-star-b67d
```

A live public deployment of this template is available at [https://crimson-star-b67d.templates.workers.dev](https://crimson-star-b67d.templates.workers.dev)
